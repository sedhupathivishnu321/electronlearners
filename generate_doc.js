...
function generateMSOHTML() {
  let expBlocks = experiments.map(exp => `
    <div className="experiment-card" style="page-break-before: always; margin-bottom: 40px; padding: 25px; border: 3px solid #2563eb; border-radius: 20px; background-color: #0f172a; color: #f8fafc; font-family: 'Segoe UI', Arial, sans-serif;">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 20px; border-bottom: 2px solid #2563eb; padding-bottom: 15px;">
        <tr>
          <td width="20%" align="center" style="background-color: #2563eb; color: #ffffff; padding: 12px; border-radius: 12px; font-weight: bold;">
            ...
            <div style="font-size: 24px; font-weight: 900;">#${exp.num}</div>
          </td>
          <td width="60%" align="center" style="padding: 0 15px;">
            <div style="background-color: #1e293b; border: 2px solid #3b82f6; padding: 12px; border-radius: 12px; text-align: center;">
              <h2 style="margin: 0; color: #ef4444; font-size: 20px; font-weight: 900; letter-spacing: 1px; text-transform: uppercase;">${exp.title}</h2>
            </div>
          </td>
        ...
        <tr valign="top">
          ...
          <td width="35%" style="padding-right: 15px;">
            ...
            <div style="margin-bottom: 15px;">
              <span style="background-color: #f59e0b; color: #0f172a; font-weight: bold; font-size: 11px; padding: 4px 10px; border-radius: 6px; text-transform: uppercase; display: inline-block; margin-bottom: 6px;">💡 CONCEPT</span>
              <div style="background-color: #1e293b; border: 1px solid #334155; padding: 12px; border-radius: 10px; font-size: 12px; color: #e2e8f0; font-weight: 600;">
                ${exp.concept}
              </div>
            </div>
            ...
            <!-- COMPONENTS -->
            <div style="margin-bottom: 15px;">
              <span style="background-color: #10b981; color: #ffffff; font-weight: bold; font-size: 11px; padding: 4px 10px; border-radius: 6px; text-transform: uppercase; display: inline-block; margin-bottom: 6px;">🛠️ COMPONENTS</span>
              <div style="background-color: #1e293b; border: 1px solid #334155; padding: 12px; border-radius: 10px; font-size: 11px; color: #cbd5e1;">
                ${exp.components.map(c => `<div>• ${c}</div>`).join('')}
              </div>
            </div>

            <!-- LEARNING -->
            <div style="margin-bottom: 15px;">
              <span style="background-color: #9333ea; color: #ffffff; font-weight: bold; font-size: 11px; padding: 4px 10px; border-radius: 6px; text-transform: uppercase; display: inline-block; margin-bottom: 6px;">📚 LEARNING</span>
              <div style="background-color: #1e293b; border: 1px solid #334155; padding: 12px; border-radius: 10px; font-size: 11px; color: #cbd5e1;">
                ${exp.learning.map(l => `<div>• ${l}</div>`).join('')}
              </div>
            </div>
          ...
          <td width="65%">
            ...
            <!-- CIRCUIT DIAGRAM -->
            <div style="margin-bottom: 15px;">
              <span style="background-color: #0891b2; color: #ffffff; font-weight: bold; font-size: 11px; padding: 4px 10px; border-radius: 6px; text-transform: uppercase; display: inline-block; margin-bottom: 6px;">⚡ CIRCUIT DIAGRAM & SCHEMATIC</span>
              <div style="background-color: #1e293b; border: 1px solid #334155; padding: 12px; border-radius: 10px; font-family: 'Courier New', monospace; font-size: 11px; color: #67e8f9; white-space: pre-wrap;">
                ${exp.circuitDiagram}
              </div>
            </div>
            ...
            <!-- CODE BLOCK -->
            <div style="margin-bottom: 15px;">
              <span style="background-color: #2563eb; color: #ffffff; font-weight: bold; font-size: 11px; padding: 4px 10px; border-radius: 6px; text-transform: uppercase; display: inline-block; margin-bottom: 6px;">💻 ARDUINO C++ CODE</span>
              <div style="background-color: #090d16; border: 1px solid #1e293b; padding: 12px; border-radius: 10px; font-family: 'Courier New', monospace; font-size: 11px; color: #34d399; white-space: pre-wrap;">
                ${exp.code}
              </div>
            </div>
            ...
            <!-- EXPLANATION -->
            <div style="margin-bottom: 15px;">
              <span style="background-color: #4f46e5; color: #ffffff; font-weight: bold; font-size: 11px; padding: 4px 10px; border-radius: 6px; text-transform: uppercase; display: inline-block; margin-bottom: 6px;">📝 EXPLANATION</span>
              <div style="background-color: #1e293b; border: 1px solid #334155; padding: 12px; border-radius: 10px; font-size: 11px; color: #cbd5e1; line-height: 1.5;">
                ${exp.explanation}
              </div>
            </div>
      ...
      <!-- FOOTER -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 15px; border-t: 2px solid #2563eb; padding-top: 15px;">
        <tr valign="top">
          <td width="35%" style="padding-right: 10px;">
            <div style="background-color: #1e293b; border: 1px solid #334155; padding: 10px; border-radius: 10px;">
              ...
              <div style="font-size: 11px; color: #cbd5e1; margin-top: 4px;">${exp.working}</div>
            </div>
          </td>
          <td width="35%" style="padding-right: 10px;">
            <div style="background-color: #1e293b; border: 1px solid #334155; padding: 10px; border-radius: 10px;">
              <span style="color: #34d399; font-weight: bold; font-size: 10px; text-transform: uppercase;">EXPECTED RESULT</span>
              <div style="font-size: 11px; color: #cbd5e1; margin-top: 4px;">${exp.result}</div>
            </div>
          </td>
          <td width="30%">
            <div style="background-color: #78350f; border: 2px solid #f59e0b; padding: 10px; border-radius: 10px; color: #fef3c7;">
              ...
              <div style="font-size: 11px; margin-top: 4px;">${exp.tip}</div>
            </div>
          </td>
        </tr>
      </table>
...
// Write to Desktop files:
const desktopPath = path.join(process.env.USERPROFILE || 'C:\\Users\\sedhu', 'Desktop');
const docPath = path.join(desktopPath, 'Arduino_15_Experiments_STEM_Manual.doc');
const htmlPath = path.join(desktopPath, 'Arduino_15_Experiments_STEM_Manual.html');
const projectDocPath = path.join(__dirname, 'Arduino_15_Experiments_STEM_Manual.doc');

const content = generateMSOHTML();

fs.writeFileSync(docPath, content, 'utf8');
fs.writeFileSync(htmlPath, content, 'utf8');
fs.writeFileSync(projectDocPath, content, 'utf8');

console.log('✅ Successfully created Word (.doc) and HTML Manual files on Desktop:');
console.log('📄 Word File: ' + docPath);
