...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState('alex@electronlearners.com');
      ...
      <form onSubmit={handleSubmit} className="p-8 rounded-3xl glass-card border border-slate-800 space-y-4 text-xs">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input type="password" required defaultValue="••••••••" className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-9 pr-3 py-2 text-white" />
          </div>
        </div>
