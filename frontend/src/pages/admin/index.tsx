      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-b border-slate-800 pb-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-slate-400 text-xs">JR Learners Platform Master Management • Version 2026.1</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="p-6 rounded-2xl glass-card border border-slate-800 space-y-3 text-xs text-slate-300">
            <div className="flex justify-between border-b border-slate-800/80 pb-2">
              ...
              <span className="text-amber-400">admin@jrlearners.com (SuperAdmin)</span>
            </div>
            <div className="flex justify-between border-b border-slate-800/80 pb-2">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-blue-400">alex@jrlearners.com (Student Access)</span>
            </div>
          </div>
        </div>
      )}
