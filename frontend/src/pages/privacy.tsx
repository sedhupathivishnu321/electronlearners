...
export default function PrivacyPolicy() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 space-y-6 text-xs text-slate-300">
      ...
      <p>ElectronLearners ("we", "our", "us") values your privacy. This policy outlines how we handle personal data collected across our web platform and e-commerce store.</p>
