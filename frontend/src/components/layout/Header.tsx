    ...
    <header className="sticky top-0 z-50 bg-[#0F172A]/90 backdrop-blur-md border-b border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden lg:flex items-center space-x-6 text-sm font-medium text-slate-300">
            ...
            <Link href="/simulator" className="hover:text-cyan-400 transition-colors flex items-center gap-1">
              <Cpu className="w-4 h-4 text-cyan-400 animate-pulse" /> Simulator
            </Link>
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden bg-slate-900 border-b border-slate-800 px-4 pt-2 pb-6 space-y-3">
          ...
          <Link href="/simulator" className="block text-sm font-medium text-cyan-400 py-1 font-bold">⚡ Interactive Simulator</Link>
